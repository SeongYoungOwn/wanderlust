...
<head>
    ...
    <title>공지사항 작성 - AI 여행 동행 매칭 플랫폼</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="page-header">
            <div class="container">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="h2 mb-1"><i class="fas fa-plus me-2"></i>공지사항 작성</h1>
                        <p class="mb-0">새로운 공지사항을 작성합니다</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="form-container">
                        <form method="post" action="${pageContext.request.contextPath}/notice/create" onsubmit="return validateForm()">
                            <!-- Important Notice -->
                            <div class="important-notice">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="isImportant" id="isImportant" value="true">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="text-muted">
                                        ...
                                        관리자: ${sessionScope.loginUser.userName} (${sessionScope.loginUser.userId})
                                    </span>
                                </div>
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save me-1"></i>공지사항 등록
                                    </button>
                                </div>
                            </div>
                        </form>
